...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    CvCategory: typeof import('./components/Cv/Category.vue')['default']
    CvCompetenceItem: typeof import('./components/Cv/Competence/Item.vue')['default']
    CvContactItem: typeof import('./components/Cv/Contact/Item.vue')['default']
    CvExperienceItem: typeof import('./components/Cv/Experience/item.vue')['default']
    CvLayoutHeader: typeof import('./components/Cv/Layout/Header.vue')['default']
    CvSchoolItem: typeof import('./components/Cv/School/Item.vue')['default']
