export const companyTranslationMessages = {
  fr: {
    'website': {
    ...
    'teliae-1': {
      ...
      competencies: {
        web: 'Développement Web',
        language_php: 'Programmation Back End',
        account_group: 'Suivi client',
      },
      infoGold: {
        name: 'Stage Développeur Web',
        suffix: 'Mois',
    ...
    'aife-1': {
      ...
      competencies: {
        video: 'Montage Vidéo',
        speak: 'Animation de stream',
        teach_poll: 'Vulgarisation',
      },
      infoGold: {
    ...
    'aife-2': {
      ...
      competencies: {
        web: 'Développement Web',
        palette: 'Design UX',
        content_copy: 'Intégration de contenu',
      },
      infoGold: {
  ...
  en: {
    ...
    'az-network': {
      name: 'AZ Network',
      location: 'Alençon, France (61)',
      description: 'AZ Network is a company working on the implementation and maintenance of CRM and ERP solutions.',
      work: 'Web Developer Internship',
      workDescription: 'I worked on updating the Génerix ERP at various clients. I had to perform data searches via SQL queries, update files to adapt specific updates via regular expressions.',
      competencies: {
        web: 'Web Development',
        database: 'Database',
    ...
    'teliae': {
      name: 'Teliae',
      location: 'Taluyers, France (69)',
      description: 'Teliae is a company offering logistics solutions for transport companies (Transport Management System).',
    },
    'teliae-1': {
      work: 'Internship in Web Development',
      workDescription: 'I started in this company with an internship. My role was to maintain and add features to a delivery route management application.',
      competencies: {
        web: 'Web Development',
    ...
    'teliae-2': {
      ...
      workDescription: 'I had the opportunity to be assigned to multiple missions with varying ambitions. Among my biggest missions, I had to redesign the visual interface of an old application. I had to implement a solution to adapt the interface to new accessibility standards, while maintaining a simple and intuitive interface. All while accompanying users in the evolution of their tool.',
      competencies: {
        web: 'Web Development',
        palette: 'UX Design',
        account_group: 'Client Support',
    ...
    'aife': {
      name: 'Aife',
      location: 'Alençon, France (61)',
      description: 'Aife is the name I chose for my company as a freelance. It includes my work as a web developer and my activities as a content creator.',
    },
    'aife-1': {
      work: 'Créateur de contenu',
      workDescription: 'I started creating videos for YouTube. The concept is based on explaining and popularizing complex technical subjects in video games. Mainly Glitches and Speedruns. The videos have a primary desire to make complex mechanics understandable in a language accessible to all. I was able to reach over 100,000 subscribers and millions of views. I diversified into the production of live videos and streams.',
      competencies: {
        video: 'Video Editing',
    ...
    'aife-2': {
      work: 'Web Developer',
      workDescription: 'My activities are diverse, from creating showcase sites, maintaining existing sites, to content integration. My skills in development, design, and content creation allow me to respond to a wide range of requests. I use my skills to develop various tools to facilitate my work as a content creator.',
      competencies: {
        web: 'Web Development',
        palette: 'UX Design',
