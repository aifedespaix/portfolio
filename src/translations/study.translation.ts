export const studyTranslationMessages = {
  fr: {
    'iut-caen': {
      ...
      competencies: {
        ...
        server: 'Administration système et réseaux',
      },
    },
    'fac-lyon': {
  ...
  en: {
    'iut-caen': {
      ...
      description: 'General computer science training, I discovered the basics of computer science and programming. This training allowed me to validate my interest in web development while providing me with a solid background in computer science.',
      competencies: {
        web: 'Web Development',
        database: 'Database',
    ...
    'fac-lyon': {
      ...
      description: 'This year was a turning point for me and the vision of the profession I wanted to pursue. I went through this year without validating it. I still acquired strong knowledge in algorithms and UX design.',
      competencies: {
        web: 'Web Development',
        palette: 'UX Design',
    ...
    'institut-g4': {
      ...
      description: `I focused on the field of IT project management. Having varied knowledge and being interested in all aspects of project implementation, it is natural for me to think and design optimal solutions, whether organizational or in accordance with technical constraints. I also participated in training students in my areas of expertise. The transmission of knowledge is an important concept for me.`,
      competencies: {
        web: 'Web Development',
